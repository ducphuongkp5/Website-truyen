...
<body>
    ...
    <main>      
        <div class="container">
            <div class="link-id" style="margin-left: 100px;margin-bottom:50px;font-family: quicksand,sans-serif!important">
               <h2> Liên hệ với chúng tôi! </h2>
            </div>
        
            <div class="row">
                <div class="center-side" style="height:300px;margin-left:100px">
                Nếu có bất kỳ yêu cầu kinh doanh, phản hồi hay đề nghị hãy liên hệ với chúng tôi qua kohiloli@gmail.com
                </div>
