<?php 
    ...
    if($check){
        ...
        if($checkquyen==1){
            ...
            $follow = "Admin/index.php";
        }
        else{
            $href1="AUser/index.php";
            $follow = "AUser/index.php";
        }
    ...
    <nav>
      ...
      <div class="content">
        <div class="icon"> <a href="index.php" style="text-decoration: none; color: white">Kohi<b style="color: aqua">Loli</b></a></div>
                  ...
                  <?php 
                   ...
                   if($query){
                       while ($row = $query->fetch_assoc()) {
                           echo '<li class="genes"><a href="theloai.php?theloai='.$row['Slug'].'">'.$row['THELOAITRUYEN'].'</a></li>';
                       }
                   }
            ...
            <li class="dis"><a href="<?= $href1 ?>">Cài đặt</a></li>
            </ul>
        </div>
