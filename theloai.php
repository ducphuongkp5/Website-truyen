...
<body>
    <?php 
        ...
        // $theloai= mysql_query("SELECT THELOAIJTRUYEN FROM THONGTINTHELOAI WHERE Slug=.$_GET['theloai'].")
        // // $query = mysql_query("SELECT * FROM truyen WHERE THELOAITRUYEN LIKE='$username'");
        // $theloai2= mysqli_query($conn,"SELECT THELOAITRUYEN FROM THONGTINTHELOAI WHERE Slug= '.$_GET['theloai'].'")
    ?>
